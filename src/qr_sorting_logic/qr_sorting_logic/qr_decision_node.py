...
class QrDecisionNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('bin_a.pose', [0.35, 0.25, 0.18, 0.0, 0.0, 0.0, 1.0])
        self.declare_parameter('bin_b.pose', [0.45, 0.00, 0.18, 0.0, 0.0, 0.0, 1.0])
        self.declare_parameter('bin_c.pose', [0.35, -0.25, 0.18, 0.0, 0.0, 0.0, 1.0])
        self.declare_parameter('reject_bin.pose', [0.25, -0.40, 0.18, 0.0, 0.0, 0.0, 1.0])
